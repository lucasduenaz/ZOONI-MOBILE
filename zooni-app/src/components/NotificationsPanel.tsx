...
export default function NotificationsPanel({ visible, onClose, onNavigate }: Props) {
  ...
  const handleTap = async (item: Notificacion) => {
    if (!item.leida) {
    ...
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          <TouchableOpacity onPress={onClose} accessibilityLabel="Cerrar notificaciones">
...
const styles = StyleSheet.create({
  ...
  itemUnread: {
    backgroundColor: 'rgba(45, 189, 114, 0.08)',
  },
  avatarWrap: {
    marginRight: 12,
  },
